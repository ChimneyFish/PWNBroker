...
# Invoke pip via "python -m pip", not the pip executable directly — pip's own
# recommended way to upgrade itself, and avoids platform-specific self-replace quirks.
